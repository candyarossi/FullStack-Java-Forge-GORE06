...
public class Videojuegos implements ManejoDeFechas {
	...
	@GetMapping("/getGames")
	public String getGames(Model modelo) {
	...
	public String guardar(@RequestParam String nombre, @RequestParam String descripcion, @RequestParam String portada,
		...
		Videojuego videojuego = new Videojuego(nombre, descripcion, portada, formatearFecha(fecha_lanzamiento),
	...
	public String detalle(@PathVariable("nombre") String nombre, Model modelo) {
		Videojuego videojuego = buscar(nombre);
